                           ...
                           <div class="border border-3 p-4 rounded">
							<div class="mb-3">
                              ...
                              <div class="mb-3">
                                ...
                                <div class="mb-3">
	<img id="showImage" src="{{url('upload/no-image.jpg') }}" style="width: 100px; height: 100px" />
								</div>
                              ...
                              <div class="row g-3">
								<div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
									...
									<input type="text" name="special_price" class="form-control" id="inputPrice" placeholder="00.00">
								  </div>
                ...
                @endforeach
                    ...
                    <div class="mb-3">
						...
						<input type="text" name="color" class="form-control visually-hidden" data-role="tagsinput" value="Red,White,Black,Blue">
				    </div>

                    <div class="form-check">
									<input class="form-check-input" type="checkbox" name="remark" value="FEATURED" id="flexCheckChecked" checked="">
									<label class="form-check-label" for="flexCheckChecked">FEATURED</label>
								</div>
                    <div class="form-check">
									<input class="form-check-input" type="checkbox" name="remark" value="NEW" id="flexCheckChecked" checked="">
									<label class="form-check-label" for="flexCheckChecked">NEW</label>
								</div>
                   
                    <div class="form-check">
									<input class="form-check-input" type="checkbox" name="remark" value="COLLECTION" id="flexCheckChecked" checked="">
