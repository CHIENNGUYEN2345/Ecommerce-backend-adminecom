<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				...
				<div>
					<h4 class="logo-text">EasyShop</h4>
				</div>
            ...
            <li>
				...
				<li>
					...
					<ul>
						...
						<li> <a href="{{route('add.category')}}"><i class="bx bx-right-arrow-alt"></i>Add Categories</a>
						</li>
				...
				<li>
					<a class="has-arrow" href="javascript:;">
						...
						<div class="menu-title">Sub-cate</div>
					</a>
					<ul>
						<li> <a href="{{route('all.subcategory')}}"><i class="bx bx-right-arrow-alt"></i>All Sub-cate</a>
						</li>
						<li> <a href="{{route('add.subcategory')}}"><i class="bx bx-right-arrow-alt"></i>Add Sub-cate</a>
						</li>
					</ul>
				</li>
				<li>
